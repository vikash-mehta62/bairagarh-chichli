      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-gray-400 leading-relaxed mb-6 max-w-lg text-lg">
              Company Name Solutions Infra is a trusted real estate leader with
              25+ years of unparalleled experience. We've proudly served over
              5,000 clients and facilitated sales exceeding 1,000,000 sq. ft. of
              prime property. Your property journey, our expert guidance.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <a
                  href="mailto:info@Company Namesolutions.com"
                  className="text-gray-400 hover:text-blue-500 transition-colors duration-200"
                >
        ...
        <div className="border-t border-gray-700 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-500 text-sm mb-4 md:mb-0">
            © {new Date().getFullYear()} Company Name Solutions Real Estate. All
            rights reserved.
          </p>

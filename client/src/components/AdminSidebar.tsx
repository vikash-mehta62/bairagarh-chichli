...
const AdminSidebar = () => {
  ...
  const menuItems = [
    ...
    { href: "/admin/inquiry", icon: <Building />, label: "General Inquiry" },
    { href: "/admin/add-blog", icon: <FcPlus />, label: "Add Blog" },
    { href: "/admin/get-blog", icon: <FcPieChart />, label: "Get Blog" },

    {
      href: "/admin/get-applications",
      icon: <Building />,
      label: "Get Applications",
    },
    { href: "/admin/add-job", icon: <Plus />, label: "Add Job" },
    { href: "/admin/get-jobs", icon: <Building />, label: "Get Jobs" },
    user?.isManageEmp && {
      href: "/admin/crm",
      icon: <Building />,
      label: "Manage Employee (HRM)",
    },
    {
      href: "/admin/get-support",
      icon: <Building />,
